...
public class AdminAuthService {
    ...
    @Autowired
    public AdminAuthService(AdminRepository adminRepository, RedisTemplate<String, Object> redisTemplate, MailUtil mailUtil) {
    ...
    public Pair<AuthServiceEnum, String> login(String username, String password) throws JsonProcessingException {
        ...
        // 验证码发送邮箱
        boolean result = mailUtil.sendVerificationCode(email, code, VerificationCodePurpose.AdminLogin);
        if (!result) {
