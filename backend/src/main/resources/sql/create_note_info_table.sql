...
(
    ...
    created_at    DATETIME     DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间，默认当前时间',                -- 使用 DATETIME
    updated_at    DATETIME     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间', -- 使用 DATETIME
