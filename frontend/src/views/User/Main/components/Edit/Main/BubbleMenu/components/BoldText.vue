...
<template>
  ...
  >
    ...
    <!-- 加粗 -->
    <el-button text class="button" @click="bold(editor)" style="margin: 0 !important">
      <el-icon color="#000000" size="16" v-show="!isBoldActive(editor)">
        <Bold/>
      </el-icon>
      <el-icon color="#2383E2" size="16" v-show="isBoldActive(editor)">
        <Bold/>
      </el-icon>
    </el-button>
